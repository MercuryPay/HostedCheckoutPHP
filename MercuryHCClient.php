...
class MercuryHCClient
{
    ...
    public function __construct($env, $merchantId, $password)
    {
        $this->merchantId = $merchantId;
        $this->password = $password;
        
        // Hosted Checkout API WSDL URL
        $url = ($env == 'production') ? 'pay.com' : 'cert.net';
        $wsUrl = 'https://hc.mercury' . $url . '/hcws/HCService.asmx?WSDL';

        $this->wsClient = new SoapClient($wsUrl);
    }
